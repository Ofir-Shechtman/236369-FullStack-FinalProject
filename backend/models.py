...
class Poll(db.Model):
    ...
    def serialize(self):
        ...
        return {
            ...
            'poll_answers': [{'user': receiver.user.first_name, 'answers': [answer.option.content for answer in receiver.poll_answers], 'time_answered':min([answer.time_answered for answer in receiver.poll_answers])} for receiver in self.poll_receivers]
        }
