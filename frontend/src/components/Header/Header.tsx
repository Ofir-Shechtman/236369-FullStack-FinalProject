...
import {FaTelegramPlane, FaList, FaSignOutAlt, FaInfo, FaPlusCircle, FaPoll, FaUserCircle} from "react-icons/fa";
      ...
      <ProSidebar>
        ...
        <SidebarContent>
          <Menu iconShape="circle">
            ...
            <MenuItem icon={<FaUserCircle />} onClick={() => changePage(1)}>Admins List</MenuItem>
