...
export const AddNewPoll: React.FC<AddNewPollProps> = ({
    ...
    const onSubmit = (data: any) => {
        ...
        data['MultipleOptions'] = Array.from(inputFields).map((inputField: { id: React.Key | null | undefined; Option: unknown; FollowupPoll: unknown }) => ({
            "option": inputField.Option,
            "poll_id": inputField.FollowupPoll
        }))
            ...
            <Paper elevation={24} className="Paper">
                <form onSubmit={handleSubmit(onSubmit)}>
                    <Stack spacing={3}>
                        ...
                        <SwitchForm name={"Allow Multiple Answers"} type_value={poll_type}
                        ...
                        <MultipleOptions name={"Multiple Options"} inputFields={inputFields}
